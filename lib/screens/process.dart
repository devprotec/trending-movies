...
class Ptocess extends StatelessWidget {
  final List<VideoInfo> downLoadList;
  Ptocess(this.downLoadList);
...
class MyHomePage extends StatefulWidget with WidgetsBindingObserver {
  ...
  MyHomePage({Key key, this.title, this.platform, this.movieList})
      : super(key: key);
  ...
  /* final _videos = [
    {
      'name': 'Big Buck Bunny',
      'link':
          'https://firebasestorage.googleapis.com/v0/b/advanceauth.appspot.com/o/movies%2FSan.Andreas.2015.1080p.mp4?alt=media&token=3a3cfc63-73d2-4fb8-b7c5-96741a67d979'
    },
    {
      'name': 'Elephant Dream',
      'link':
  ...
  Future<Null> _prepare() async {
    ...
    for (int i = 0; i < widget.movieList.length; i++) {
      _tasks.add(_TaskInfo(
          imageLink: widget.movieList[i].imageLink,
          name: widget.movieList[i].name,
          link: widget.movieList[i].videoLink));
...
class _TaskInfo {
  ...
  _TaskInfo({this.imageLink, this.name, this.link});
}
...
class _ItemHolder {
  ...
  _ItemHolder({this.imageLink, this.name, this.task});
}
 */
