...
class PaypalPayment extends StatefulWidget {
  static String routeName = "paypal_payment";
  final Function onFinish;
  final User user;
  final VideoInfo movieInfo;

  PaypalPayment(
      {@required this.onFinish, @required this.user, @required this.movieInfo});
...
class PaypalPaymentState extends State<PaypalPayment> {
  ...
  String itemName = 'Movie Download';
        ...
        body: WebView(
          ...
          navigationDelegate: (NavigationRequest request) {
            ...
            if (request.url.contains(cancelURL)) {
              ...
              List newPayList = widget.movieInfo.pay;
              newPayList.add(widget.user.uid);
              FirebaseFirestore.instance
                  .collection('movies')
                  .doc(widget.movieInfo.id)
                  .update({'pay': newPayList});
            }
